...
mvn install:install-file -Dfile=bc/bcprov-jdk15on-156b06.jar -DpomFile=bc/bcprov-jdk15on.pom

mvn install:install-file -Dfile=bc/bcpkix-jdk15on-156b06.jar -DpomFile=bc/bcpkix-jdk15on.pom
